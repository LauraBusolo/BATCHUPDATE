...
def countRows(input_table, out_feature_class):
    ...
    print ("input_table, out_feature_class : " + input_table + ", " + out_feature_class)
    ...
    while row:
        ...
        row = rows.next()
    print ("input_table_result count is " + str(input_table_result) + "\n")
    ...
    while row2:
        ...
        row2 = rows2.next()
    print ("out_feature_class_result count is " + str(out_feature_class_result) + "\n")
